...
- **GitHub** — Sign in with your GitHub account. Required for [GitHub integration](/denoise/github-integration/) (linking milestones, syncing issues, converting tasks to issues).
...
Sign-in uses OAuth: click **Sign In**, choose GitHub or Google, complete the flow in your browser, and you are redirected back to the app with a session. Your session is stored in a cookie and validated by the server. GitHub sign-in uses a **GitHub App** (user-to-server); you can choose which repositories to grant access to and manage installations at [github.com/settings/installations](https://github.com/settings/installations).

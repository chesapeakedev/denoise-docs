---
title: Introduction
description: Documentation for denoise - a set of tools for managing agentic workflows to create software factories.
---
...
| Automate in GitHub Actions                   | [Headless Use](/dn-cli/headless-use/) → [OpenCode](/cookbooks/opencode/), [Claude Code](/cookbooks/claude-code/), [Codex](/cookbooks/codex/), or [Cursor](/cookbooks/cursor/)                       |
